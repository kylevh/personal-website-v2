    ...
    return (
        <main className="flex min-h-screen  justify-center p-2 bg-kyle-white">
            <div className='grid grid-cols-3 md:grid-cols-12 p-4 gap-2 min-h-screen align-top w-full max-w-[100rem]'>
                ...
                {/* NavBar */}
                <FadeInAnimation className='col-span-3 md:col-span-12  h-60'>
                ...
                <UpAnimation className='flex flex-col col-span-6'>
                    <div className="flex flex-row md:flex-col items-center w-full">
                        <div className='flex-1'>
                            ...
                            {item.link1 && (
                                <div className="md:block md:mt-10">
                                    <h1 className={`${sf.className} font-light text-3xl underline`}><Link href={item.link1}>github</Link></h1>
                                </div>
                            )}
                            {item.link2 && (
                                <div className="md:block md:mt-2">
                                    <h1 className={`${sf.className} font-light text-3xl underline`}><Link href={item.link2}>link</Link></h1>
                                </div>
                            )}
                        </div>
                ...
                {/* Right section */}
                <UpAnimation className='col-span-4 col-start-1 md:col-start-7 h-auto w-full mt-8 md:mt-0 md:ml-14'>
