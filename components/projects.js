const projects = [
    {
        ...
        pageDesc: 'Penguin Wars is a captivating 3D turn-based strategy game created for the UW TRI-CAMPUS GAME JAM 2021. This gaming masterpiece utilizes the Unity engine and the power of C# to bring a world of penguin warfare to life. Immerse yourself in a whimsical realm where adorable penguins engage in turn based battles, all rendered with Unity 3D graphics. Dive into this strategic adventure today and experience the thrill of commanding a penguin army in a quest for victory.',
    ...
    },
    {
        ...
        pageDesc: `CorpseBound is a captivating project that emerged from the creative talents of a few UW students. In the game, players embark on a unique journey that delves into the intriguing theme of mortality. As a player, you navigate a mysterious world where death is not the end but a means to explore inaccessible areas of the map. CorpseBound encompasses a range of skills, including game design, programming, and 2D graphics, making it a standout in the 2020 UW Game Jam`,
